...
public class UserInfoResource {
    ...
    public ResponseEntity<List<UserInfo>> getAllUserInfos(Pageable pageable, @RequestParam(required = false) String filter) {
        if ("user-is-null".equals(filter)) {
            log.debug("REST request to get all UserInfos where user is null");
            return new ResponseEntity<>(userInfoService.findAllWhereUserIsNull(), HttpStatus.OK);
        }
