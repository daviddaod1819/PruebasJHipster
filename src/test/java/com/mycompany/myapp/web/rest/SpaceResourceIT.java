...
public class SpaceResourceIT {
    ...
    public void createSpace() throws Exception {
        ...
        assertThat(testSpace.getImage()).isEqualTo(DEFAULT_IMAGE);
        assertThat(testSpace.getImageContentType()).isEqualTo(DEFAULT_IMAGE_CONTENT_TYPE);
    ...
    public void updateSpace() throws Exception {
        ...
        assertThat(testSpace.getImage()).isEqualTo(UPDATED_IMAGE);
        assertThat(testSpace.getImageContentType()).isEqualTo(UPDATED_IMAGE_CONTENT_TYPE);
