...
import { UsermComponent } from 'app/entities/userm/userm.component';
import { UsermService } from 'app/entities/userm/userm.service';
import { Userm } from 'app/shared/model/userm.model';

describe('Component Tests', () => {
  describe('Userm Management Component', () => {
    let comp: UsermComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UsermComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userms && comp.userms[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
